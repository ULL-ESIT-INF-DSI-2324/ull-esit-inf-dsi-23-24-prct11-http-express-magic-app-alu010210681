...
export declare class GestorCartas {
     ...
     */
    static addCarta(usuario: string, carta: Carta): Promise<string>;
    /**
     ...
     * @param callback Función callback que se ejecuta al finalizar la operación.
     */
    static modificarCarta(usuario: string, cartaModificada: Carta): Promise<string>;
    /**
     ...
     * @param callback Función callback que se ejecuta al finalizar la operación.
     */
    static eliminarCarta(usuario: string, idCarta: number): Promise<string>;
    /**
